import { getExamplePreviousNext, getPreviousNext } from "@/lib/markdown";
...
export function ExamplePagination({ pathname }: { pathname: string }) {
  const res = getExamplePreviousNext(pathname);
